...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="#" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bold">Ecommerce</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <!-- Popular Brands -->
        <li class="menu-item ">  
            <a href="{{ url('popular-brand') }}" class="menu-link">
        ...
        <!-- Complaints -->
        <li class="menu-item {{ (request()->is('complaint')) || (request()->is('complaint*')) ? 'active' : '' }}">  
